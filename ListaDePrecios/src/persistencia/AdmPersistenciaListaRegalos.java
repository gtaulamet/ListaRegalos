...
//			s.setInt(1,l.getCodigo());
	...
	public Map<Integer,ListaDeRegalos> BuscarListaAgasajo(java.util.Date fecha) {
		try
		{
			ListaDeRegalos l = null;
			Connection con = PoolConnection.getPoolConnection().getConnection();
			PreparedStatement s = con.prepareStatement("select lr.* from  BD_ListaRegalos.dbo.ListaDeRegalos lr \r\n" + 
					" where lr.estado like 'Finalizada' \r\n" + 
					" and lr.FechaAgasajo =?");			
		...
		{
			System.out.println("Error al buscar las listas de regalo de la fecha de agasajo.");
		}
		return null;
	}
	
	public Map<Integer,ListaDeRegalos> BuscarListaInicio(java.util.Date fecha) {
		try
		{
			ListaDeRegalos l = null;
			Connection con = PoolConnection.getPoolConnection().getConnection();
		...
		{
			System.out.println("Error al buscar las listas de regalo de la fecha de inicio.");
		}
		return null;
	}
